...
def plot_line(x, y1, y2, y3, y4, l1, l2, l3, l4, title, m, subim):
...
if __name__ == "__main__":
    ...
    avg_f1 = pickle.load(open('../05/outputs/v4/avg_reg_error_motifs.pickle', 'rb'))
    ...
    for m in motif_pattern:
        ...
        # print(title)
        # for idx_feat in range(len(X_string)):
        #     print(X_string[idx_feat], Y[idx_feat][0])

        plot_line(intervals_tit, Y[0], Y[1], Y[2], Y[3],  X_string[0], X_string[1],
                  X_string[2], X_string[3], title, m, imgs_dict[m])
        # exit()
