            ...
            if new_nodes_count > 40:
                if cnt_intervals >= 0:
                    ...
                    for k, v in top_k_entropy:
                        if k in entropy_individuals:
                            prev_measure = entropy_individuals[k]
                    ...
                    if cnt_prev == 0:
                        entropy_velocity_cascade[cnt_intervals] = 0
                    else:
                        entropy_velocity_cascade[cnt_intervals] = measure_vel / cnt_prev
