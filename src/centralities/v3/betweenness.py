...
if __name__ == '__main__':
    ...
    output_dir = '11_05/bw/bw_change/v3/steep/'
    if not os.path.exists(output_dir):
        os.makedirs(output_dir)

    pickle.dump(measure_global_velocity, open(output_dir + 'bw_diff' + '.pickle', 'wb'))

    output_dir = '11_05/bw/bw_values/v3/steep/'
    if not os.path.exists(output_dir):
        os.makedirs(output_dir)

    pickle.dump(measure_global, open(output_dir + 'bw' + '.pickle', 'wb'))

    output_dir = '11_05/bw/bw_change/v3/inhib/'
    if not os.path.exists(output_dir):
        os.makedirs(output_dir)

    pickle.dump(measure_global_velocity_inhib, open(output_dir + 'bw_diff' + '.pickle', 'wb'))

    output_dir = '11_05/bw/bw_values/v3/inhib/'
    if not os.path.exists(output_dir):
        os.makedirs(output_dir)

    pickle.dump(measure_global_inhib, open(output_dir + 'bw' + '.pickle', 'wb'))