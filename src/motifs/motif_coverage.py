        ...
        if new_nodes_count > 40 or (i == len(cascade_set['source']) - 1):
            ...
            if stop_inhib_flag != 1:
                ...
                for idx_map in range(len(vertex_maps_filtered)):
                    ...
                    # Starting with a seed motif, use CP algo to find the structure
                    ...
                    while True:
                        ...
                        for idx in map:
                            ...
                            # 2. There should be at least one common node with seed motif nodes at start.
                            number_nodes_free = len(idx.a) - len(list(set(idx.a).intersection(set(nodes_covered))))
                            if number_nodes_free < 4 or number_nodes_free == 5:
                                continue
...
if __name__ == '__main__':
    ...
    pickle.dump(motifs_coverage, open('motifs_coveragt_min_1'
                                                  + '.pickle', 'wb'))
