        ...
        if new_nodes_count > 40 or (i == len(cascade_set['source']) - 1):
            if cnt_intervals >= 0:
                ...
                if stop_inhib_flag == 1:
                    motif_patterns_cascade_list = motif_patterns_cascade_list[:cnt_intervals+1]
                    return (motif_patterns_steep, motif_patterns_cascade_list)
...
if __name__ == '__main__':
    ...
    for int_prev in range(100):
        try:
            ...
            pickle.dump(count_motifs_interval_dict, open('motifs_count/5/steep/count_motifs_interval_'
    ...
    for int_prev in range(100):
        try:
            ...
            pickle.dump(count_motifs_interval_dict, open('motifs_count/5/inhib/count_motifs_interval_'
                                                     + str(int_prev) + '.pickle', 'wb'))
            count_motifs_interval_dict = {}
        except:
            continue
